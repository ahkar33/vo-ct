...
const Charity = () => {
	return (
		<div id="charity" className="py-[32px] lg:py-[64px] x-padding">
			<div className="grid md:grid-cols-2 gap-[16px] lg:gap-[32px]">
				<div className="bg-pink-dark rounded-[16px] py-[32px] lg:py-[56px] w-full md:h-[515px] h-[400px] sm:h-[500px]">
				...
				<div className="bg-white rounded-[16px] flex flex-col gap-[16px] p-[32px] lg:p-[56px] w-full md:h-[515px] h-[400px] sm:h-[500px]">
